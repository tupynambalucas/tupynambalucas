...
the [cost dashboard](../../llm/cost-controls/dashboard.md) and the Analytics page in
...
> [!WARNING] Warning Do not point multiple agentgateway instances at the same SQLite file — use PostgreSQL instead.
...
[Jaeger](/docs/standalone/latest/integrations/observability/jaeger/ 'Jaeger')
