...
(`extAuthz`)](../../configuration/security/external-authz.md) policy to delegate
...
2. Test the flow in a browser.
   ...
   1. Open <http://localhost:3000/mcp>.
   2. You are redirected to GitHub for authentication.

      ![](/img/gh-oauth-app.png)
...
[External authorizationExtAuthz configuration reference](../../configuration/security/external-authz.md) [Security configurationComplete security options](../../configuration/security/index.md) [traffic-oauth2-proxy exampleAgentgateway config example to start an OAuth2 proxy with Docker Compose](https://github.com/agentgateway/agentgateway/tree/main/examples/traffic-oauth2-proxy)

[Keycloak](/docs/standalone/latest/integrations/auth/keycloak/ 'Keycloak')[Auth0](/docs/standalone/latest/integrations/auth/auth0/ 'Auth0')
