...
token in an [authorization](../../configuration/security/mcp-authz.md) policy. Auth0
...
[OAuth2 Proxy](/docs/standalone/latest/integrations/auth/oauth2-proxy/ 'OAuth2 Proxy')[Tailscale](/docs/standalone/latest/integrations/auth/tailscale/ 'Tailscale')
