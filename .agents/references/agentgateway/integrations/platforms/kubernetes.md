...
[DocumentationFull agentgateway on Kubernetes guide](https://agentgateway.dev/docs/kubernetes/) [Quick StartDeploy agentgateway in minutes](https://agentgateway.dev/docs/kubernetes/latest/quickstart/)

[Docker](/docs/standalone/latest/integrations/platforms/docker/ 'Docker')
