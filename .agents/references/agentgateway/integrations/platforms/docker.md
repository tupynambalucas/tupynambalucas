...
Then open <http://localhost:15000/ui/> in your browser.
...
[Kubernetes](/docs/standalone/latest/integrations/platforms/kubernetes/ 'Kubernetes')[AWS](/docs/standalone/latest/integrations/platforms/aws/ 'AWS')
