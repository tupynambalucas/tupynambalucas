...
[agctl proxy config backends](/docs/standalone/latest/reference/agctl/agctl-proxy-config-backends/ 'agctl proxy config backends')[agctl proxy trace](/docs/standalone/latest/reference/agctl/agctl-proxy-trace/ 'agctl proxy trace')
