...
[agctl proxy log](/docs/standalone/latest/reference/agctl/agctl-proxy-log/ 'agctl proxy log')[agctl version](/docs/standalone/latest/reference/agctl/agctl-version/ 'agctl version')
