...
[config.yaml](https:/agentgateway.dev/examples/traffic-oidc/config.yaml)
...
- [Auth0 integration](../../integrations/auth/auth0.md)
- [MCP authentication](mcp-authn.md) for MCP-specific OAuth flows

[MCP authorization](/docs/standalone/latest/configuration/security/mcp-authz/ 'MCP authorization')
