...
[OpenAI moderation](/docs/standalone/latest/llm/prompt-guards/moderation/ 'OpenAI moderation')[Azure AI Content Safety](/docs/standalone/latest/llm/prompt-guards/azure-content-safety/ 'Azure AI Content Safety')
