...
> [!NOTE] Note Extended thinking and reasoning requires a Claude model that supports these, such as claude-opus-4-6 .
...
Foundry](azure.md#use-claude-models-on-azure-ai-foundry).

## Connect to Claude Code

To route Claude Code CLI traffic through agentgateway, see the [Claude Code integration
guide](../../integrations/llm-clients/claude-code.md).

[Amazon Bedrock](/docs/standalone/latest/llm/providers/bedrock/ 'Amazon Bedrock')[Azure](/docs/standalone/latest/llm/providers/azure/ 'Azure')
