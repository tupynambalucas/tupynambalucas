...
```markdown
# example.com Agents Context

This document is the root context router for AI agents operating in the example.com
...
bounded context in the example.com monorepo.
