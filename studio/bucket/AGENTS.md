...
1. **Free-Tier Optimization (Cloudflare R2)**:
   ...
   - **Never hardcode paths**: AI agents MUST ALWAYS resolve synchronization targets dynamically from `[assets-manifest.json](../design/assets/assets-manifest.json)`.
...
- **Typecheck**: `pnpm studio:bucket:typecheck`
- **Linter**: `pnpm studio:bucket:lint`
