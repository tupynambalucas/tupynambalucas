...
- **Network Ports**: Listens on port `9007` in local host dev mode and container internal port `8080` (mapped to host `9007`). Target registered in AgentGateway (`http://mcp-memory:8080/sse`).
- **Domain Tools**:
