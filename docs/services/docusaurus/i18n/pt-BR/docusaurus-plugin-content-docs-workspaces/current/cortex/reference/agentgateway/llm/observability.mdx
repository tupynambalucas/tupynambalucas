...
description: 'Capture LLM metrics, logs, and traces, including request and response bodies and token usage,'
sidebar_position: 2
---
...
management](/workspaces/cortex/reference/agentgateway/llm/cost-controls/virtual-keys) guide. This guide sends a
...
When you configure a [model cost catalog](/workspaces/cortex/reference/agentgateway/llm/cost-controls/costs),
...
costs](/workspaces/cortex/reference/agentgateway/llm/cost-controls/costs).
