...
Attaches to: [Route](https://agentgateway.dev/docs/standalone/latest/configuration/routes/ 'Route')[Backend](https://agentgateway.dev/docs/standalone/latest/configuration/backends/ 'Backend')(MCP Backends only)
:::note[Note]
