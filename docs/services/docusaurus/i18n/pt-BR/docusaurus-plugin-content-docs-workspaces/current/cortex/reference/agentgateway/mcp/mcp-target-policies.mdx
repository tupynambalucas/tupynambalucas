...
[Set up MCP multiplexed backends](/workspaces/cortex/reference/agentgateway/mcp/connect/virtual).
...
mcp:
  ...
  - name: service-a
    mcp:
      host: https://service-a.%PROJECT_DOMAIN%/mcp
    policies:
      backendAuth:
        key: "$SERVICE_A_API_KEY"
      backendTLS:
        hostname: service-a.%PROJECT_DOMAIN%

  - name: service-b
    mcp:
      host: https://service-b.%PROJECT_DOMAIN%/mcp
    policies:
      backendAuth:
        key: "$SERVICE_B_API_KEY"
      backendTLS:
        hostname: service-b.%PROJECT_DOMAIN%
```

## Learn more

- [MCP Authorization](/workspaces/cortex/reference/agentgateway/mcp/mcp-authz)
- [Backend Authentication](/workspaces/cortex/reference/agentgateway/configuration/security/backend-authn)
- [Configuration Reference](/workspaces/cortex/reference/agentgateway/reference/configuration/schema)
