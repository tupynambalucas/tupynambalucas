...
Para uma visão de alto nível de como as ferramentas de IA e os sistemas de design se encaixam no monorepo global, consulte a **[Visão Geral da Arquitetura Técnica](/docs/explanation/architecture-overview)**.
