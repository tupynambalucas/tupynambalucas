...
O motor compila documentos usando pipelines desacoplados que estão em conformidade com o princípio Open/Closed (SOLID). Pipelines padrão, como o `github-renderer.pipeline.ts`, orquestram o processo de compilação de documentos:
