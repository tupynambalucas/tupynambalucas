...
Este documento define as convenções de código estritas e os requisitos de qualidade para o projeto **%PROJECT_DOMAIN%**. Todo o código deve aderir a estes padrões para garantir a consistência e a manutenibilidade em todo o monorepo.
...
### 4.1. Pacotes Core (`@repo/hub/core` / `@repo/hub/core`)
