...
Por exemplo: a abordagem Diátaxis recomenda que [a arquitetura da\ documentação de referência deve refletir a arquitetura do código que ela documenta](/workspaces/docs/reference/diataxis/reference-docs#respeite-a-estrutura-do-maquinário). Isso torna as lacunas na documentação muito mais visíveis.
