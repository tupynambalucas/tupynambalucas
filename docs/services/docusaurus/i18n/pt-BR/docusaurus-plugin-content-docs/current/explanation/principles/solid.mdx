...
// hub/services/api/src/plugins/auth.ts
...
Evitamos expor modelos grandes e monolíticos ou documentos de banco de dados diretamente para camadas que não precisam deles. Em vez disso, declaramos subinterfaces precisas e esquemas Zod dentro da biblioteca `@repo/hub/core` os quais:
