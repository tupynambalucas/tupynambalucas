...
For details on how to write the CEL expressions that go in each `condition` field, see the [CEL expressions reference](https://agentgateway.dev/docs/standalone/latest).
