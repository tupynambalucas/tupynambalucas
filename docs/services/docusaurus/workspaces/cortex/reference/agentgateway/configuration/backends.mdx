...
title: Backends
description: >-
  Configure backends to route traffic to hostnames, LLM providers, and MCP
  servers.
sidebar_position: 2
...
See the [MCP connectivity guide](https://agentgateway.dev/docs/standalone/latest) for more information.
...
See the [LLM consumption guide](https://agentgateway.dev/docs/standalone/latest) for more information.
