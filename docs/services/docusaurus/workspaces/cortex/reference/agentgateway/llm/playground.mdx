...
2. Configure at least one LLM provider. For an example, see [OpenAI](/workspaces/cortex/reference/agentgateway/llm/providers/openai) or any [OpenAI-compatible provider](/workspaces/cortex/reference/agentgateway/llm/providers/custom).
...
- [Observe LLM traffic](/workspaces/cortex/reference/agentgateway/llm/observability) with metrics, logs, and traces.
- Try out CEL expressions in the [CEL playground](/workspaces/cortex/reference/agentgateway/reference/cel/playground).
