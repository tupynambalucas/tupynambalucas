---
id: quality
title: Towards a theory of quality in documentation
sidebar_position: 3
---
...
We need documentation to meet standards of _accuracy_, _completeness_,
_consistency_, _usefulness_, _precision_ and so on. We can call these
...
quality are hard to disentangle. _Having flow_ and _anticipating the user_
...
qualities such as _having flow_. Instead, such qualities can only be enquired
...
one _now_, we can never rest, because the next release or update means that
...
_functional quality_ (they must keep us appropriately warm and dry, stand up
...
characteristics - who cannot say _what_ they are - can still recognise very
well _that_ the clothing is excellent, because they find it that **it feels**
...
move in it, that it fits and moves with you well. _Your body knows it_.

And it’s the same in documentation. Perhaps you need to be a connoisseur to
recognise _what_ it is that makes some documentation excellent, but that’s
not necessary to be able to realise _that_ it is excellent. Good
...
recognise _what_ is good about it, as well as _that_ it is good. And we need
to develop an understanding of how people will _feel_ when they’re using it.
...
Although Diátaxis cannot address, or _give_ us, functional quality, it can
still serve it.

It works very effectively to _expose_ lapses in functional quality. It’s often
...
documents](/workspaces/docs/reference/diataxis/reference-docs#respect-the-structure-of-the-machinery). This makes gaps in the documentation much
...
For example, it helps documentation _fit user needs_ by describing
...
Or, in Diátaxis we are directly concerned with _flow_. In flow - whether the
...
It’s important to understand that Diátaxis can never be _all_ that is
required in the pursuit of deep quality.

For example, while it can _help_ attain beauty in documentation, at least in
its overall form, it doesn’t by itself _make documentation beautiful_.
...
reinvented. But what Diátaxis _can_ do is lay down some conditions for the
_possibility_ of deep quality in documentation.
