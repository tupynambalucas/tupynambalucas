...
For complete technical specifications on edge TLS termination, single-level wildcard domain schemes (`*-dev.%PROJECT_DOMAIN%`), and reverse proxy topologies, refer to the [Infrastructure Reference](/docs/reference/infrastructure#4-reverse-proxy--request-routing).
:::
