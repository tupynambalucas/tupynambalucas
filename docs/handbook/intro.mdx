...
3. **Start Local Infrastructure & Applications:**
   ...
   See [MONOREPO.readme.md](https://github.com/tupynambalucas/tupynambalucas/blob/develop/MONOREPO.readme.md) or the [Command Reference](./reference/commands.mdx) for details.
