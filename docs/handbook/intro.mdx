...
3. **Start Local Infrastructure & Applications:**
   ...
   See [MONOREPO.md](https://github.com/tupynambalucas/tupynambalucas/blob/develop/MONOREPO.md) or the [Command Reference](./commands-reference.mdx) for details on running `pnpm hub:dev`.
