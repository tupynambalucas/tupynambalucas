...
3. **Start Local Infrastructure & Applications:**
   ...
   See [.github/README.md](https://github.com/tupynambalucas/tupynambalucas/blob/develop/.github/README.md) or the [Command Reference](./reference/commands.mdx) for details on running `pnpm hub:dev`.
