...
3. **Profile Statistics Generation**: The `@/profile` workspace compiles GitHub metrics using a native Zig CLI and dynamically overwrites the root `README.md` file.
...
- **`@/profile`**: Zig-based GitHub profile stats compiler.
...
<DocCardList
  items={[
    {
      type: 'link',
      href: '/docs/workspaces/docs/tutorials/diataxis-start',
      label: 'Start Here',
...
<DocCardList
  items={[
    {
      type: 'link',
      href: '/docs/workspaces/docs/explanation/diataxis/theory',
      label: 'Understanding Diátaxis',
      description: 'Towards a theory of quality in documentation.',
    },
    {
      type: 'link',
      href: '/docs/workspaces/docs/explanation/diataxis/foundations',
      label: 'Foundations',
      description: 'The two dimensions that underpin the Diátaxis map.',
    },
    {
      type: 'link',
      href: '/docs/workspaces/docs/reference/diataxis/map',
      label: 'The Map',
      description: 'The two-dimensional structure of documentation.',
    },
    {
      type: 'link',
      href: '/docs/workspaces/docs/explanation/diataxis/quality',
      label: 'Quality',
      description: 'Towards a theory of quality in documentation.',
    },
    {
      type: 'link',
      href: '/docs/workspaces/docs/explanation/diataxis/tutorials-vs-how-to',
      label: 'Tutorials and How-to Guides',
      description: 'The difference between a tutorial and how-to guide.',
    },
    {
      type: 'link',
      href: '/docs/workspaces/docs/explanation/diataxis/reference-vs-explanation',
      label: 'Reference and Explanation',
      description: 'The difference between reference and explanation.',
    },
    {
      type: 'link',
      href: '/docs/workspaces/docs/explanation/diataxis/complex-hierarchies',
