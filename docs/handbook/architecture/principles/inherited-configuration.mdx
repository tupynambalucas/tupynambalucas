...
description: Tooling governance and root-level config inheritance across the Elo Orgânico monorepo.
---
...
In Elo Orgânico, all toolings and configurations are centrally orchestrated from the root:
