...
For a high-level view of how AI tools and design systems fit into the global monorepo structure, refer to the **[Technical Architecture Overview](./overview.mdx)**.
