...
We avoid exposing large, monolithic models or database documents directly to layers that do not need them. Instead, we declare precise sub-interfaces and Zod schemas inside the `@repo/hub/core` library:
