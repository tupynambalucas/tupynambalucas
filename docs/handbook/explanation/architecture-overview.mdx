  ...
  items={[
    {
      ...
      description:
        'To keep the %PROJECT_DOMAIN% infrastructure, DevOps tooling, and background runtime environments robust, maintainable, and highly modular, this document unifies our self-hosted infrastructure standards, directory conventions, and multi-service Docker topologies.',
    },
    {
      type: 'link',
      ...
      label: 'Deployment',
      description:
        'To ensure high availability, security, and reproducible environments, %PROJECT_DOMAIN% utilizes a modern, self-hosted deployment model designed for Hetzner Cloud virtual machines. This guide outlines our deployment strategy, environment synchronization, and operational procedures.',
    },
  ]}
/>
...
%PROJECT_DOMAIN% follows a multi-layered security strategy. For detailed implementation details, refer to the **[Security Architecture](../reference/security.mdx)** document.
