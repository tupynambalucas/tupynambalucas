...
The **Shared Kernel** pattern is utilized when contexts share a stable portion of domain schemas or variables. In our system, **`@tupynambalucas-studio/assets`** acts as a Shared Kernel. Both `@tupynambalucas-hub/web` and `@tupynambalucas/renderer` import design tokens and SVG icons directly from this package.
