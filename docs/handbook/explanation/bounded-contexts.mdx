...
| `studio/assets`     | `@tupynambalucas-studio/assets` | **Library**     | Design tokens, logos, SVGs, and S3 sync utilities.               |
...
A standalone statistics engine built with Zig to build profile metrics. For detailed documentation, see the **[Profile Workspace](/workspaces/profile)**.

- **`@tupynambalucas/profile`**: Performance-optimized Zig compiler rendering SVG charts.
