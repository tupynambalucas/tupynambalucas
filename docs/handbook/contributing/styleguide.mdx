...
- **Git History:** Commit messages and Pull Request titles/descriptions MUST follow the Conventional Commits specification and be written in English (see [GitHub Standards](./github-standards.mdx)).
