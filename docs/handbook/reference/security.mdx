---
title: Security
description: Comprehensive overview of security measures, bot protection, and brute-force mitigation in %PROJECT_DOMAIN%.
sidebar_position: 4
---

# Security Architecture

%PROJECT_DOMAIN% implements a multi-layered security strategy to protect community data and ensure the integrity of sharing cycles. Our approach combines industry-standard protocols with specialized bot protection and brute-force mitigation.
...
- **Mandatory DTOs**: The `LoginDTOSchema` and `RegisterDTOSchema` in `@repo/hub/core` strictly require the `turnstileToken`.
