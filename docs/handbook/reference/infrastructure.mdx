...
%PROJECT_DOMAIN% utilizes an edge-to-cluster reverse proxy architecture to handle TLS termination, Zero Trust security, and request routing across bounded contexts.
...
| `turbocache-dev.%PROJECT_DOMAIN%`       | `turbocache:3000`    | `platform` | Turborepo Remote Cache Server          |
