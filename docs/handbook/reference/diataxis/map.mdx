...
|                      | [Tutorials](/docs/reference/diataxis/tutorials) | [How-to guides](/docs/reference/diataxis/how-to-guides) | [Reference](/docs/reference/diataxis/reference-docs) | [Explanation](/docs/reference/diataxis/explanation-docs) |
| -------------------- | ----------------------------------------------- | ------------------------------------------------------- | ---------------------------------------------------- | -------------------------------------------------------- |
