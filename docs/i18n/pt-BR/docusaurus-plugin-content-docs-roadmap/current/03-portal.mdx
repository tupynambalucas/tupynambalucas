...
- **Configuração da Arquitetura do Workspace**: Estruturação dos esqueletos de pacotes para `@tupynambalucas-hub/api` (Fastify v5), `@tupynambalucas-hub/web` (React 19) e `@tupynambalucas-hub/core`.
