...
O monorepo **%PROJECT_DOMAIN%** organiza instruções para modelos de linguagem através de um sistema estruturado e hierárquico de roteamento de contexto em arquivos `AGENTS.md`. Essa arquitetura garante que agentes de codificação operem com máxima precisão, sem fragmentação de contexto e com estrita observância às fronteiras de domínio.
