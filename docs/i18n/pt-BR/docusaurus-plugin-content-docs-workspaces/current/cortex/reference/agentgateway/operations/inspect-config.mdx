---
title: 'Inspect agentgateway configuration'
description: 'Inspect the runtime configuration that a standalone agentgateway instance has loaded.'
sidebar_position: 2
---
...
- Have an agentgateway instance running locally, such as the [non-agentic HTTP quickstart](/workspaces/cortex/reference/agentgateway/quickstart/non-agentic-http) setup.
