...
Attaches to: [Route](/workspaces/cortex/reference/agentgateway/configuration/security/docs/standalone/latest/configuration/routes/ 'Route')[Backend](/workspaces/cortex/reference/agentgateway/configuration/security/docs/standalone/latest/configuration/backends/ 'Backend')(MCP Backends only)
:::note[Note]
...
authorization](/workspaces/cortex/reference/agentgateway/configuration/security/http-authz), but runs in the context
of an MCP request.
:::note[Note]
...
target, see [MCP target policies](/workspaces/cortex/reference/agentgateway/mcp/mcp-target-policies).
...
authentication](/workspaces/cortex/reference/agentgateway/configuration/security/mcp-authn), you can write rules that
...
authentication](/workspaces/cortex/reference/agentgateway/configuration/security/mcp-authn), claims from the validated
...
See [MCP observability](/workspaces/cortex/reference/agentgateway/mcp/mcp-observability) for the full example, and the
[CEL reference](/workspaces/cortex/reference/agentgateway/reference/cel) for additional variables.
