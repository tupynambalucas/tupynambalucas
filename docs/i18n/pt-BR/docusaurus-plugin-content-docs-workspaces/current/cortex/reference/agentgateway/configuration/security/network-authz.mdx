...
Attaches to: [Frontend](/workspaces/cortex/reference/agentgateway/configuration/security/docs/standalone/latest/configuration/overview/ 'Frontend')
...
authorization](/workspaces/cortex/reference/agentgateway/configuration/security/http-authz).

Network authorization uses [CEL expressions](/workspaces/cortex/reference/agentgateway/reference/cel) evaluated
