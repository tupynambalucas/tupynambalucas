...
The related [`/v1/messages/count_tokens`](/workspaces/cortex/reference/agentgateway/llm/api-types/token-count)
...
see the [Anthropic provider](/workspaces/cortex/reference/agentgateway/llm/providers/anthropic) guide.
