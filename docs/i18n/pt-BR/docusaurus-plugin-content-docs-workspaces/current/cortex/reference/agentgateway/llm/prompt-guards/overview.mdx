...
description: 'How agentgateway’s content safety controls, such as PII detection and DLP, layer to guard LLM'
sidebar_position: 1
---
...
[Regex filtersUse custom regex patterns and built-in PII detectors to filter LLM requests and responses.](/workspaces/cortex/reference/agentgateway/llm/regex) [OpenAI moderationUse the OpenAI Moderation API to detect harmful content across categories including hate, harassment, and violence.](/workspaces/cortex/reference/agentgateway/llm/moderation) [AWS Bedrock GuardrailsApply AWS Bedrock Guardrails to filter LLM requests and responses for policy-violating content.](/workspaces/cortex/reference/agentgateway/llm/bedrock-guardrails) [Google Model ArmorApply Google Cloud Model Armor templates to sanitize LLM requests and responses.](/workspaces/cortex/reference/agentgateway/llm/google-model-armor) [Custom webhooksIntegrate your own content safety logic by forwarding requests and responses to a custom webhook.](/workspaces/cortex/reference/agentgateway/llm/prompt-guards/webhooks) [Multi-layered guardrailsRun prompt guards in sequence, creating defense-in-depth protection.](/workspaces/cortex/reference/agentgateway/llm/multi-layer)
