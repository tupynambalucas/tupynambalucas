...
More advanced operations are available with the [`transformation` policy](/workspaces/cortex/reference/agentgateway/configuration/transformations). Like
...
expression](/workspaces/cortex/reference/agentgateway/configuration/traffic-management/transformations) rather than
static strings.
