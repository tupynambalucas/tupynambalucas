...
- [CEL expression reference](/workspaces/cortex/reference/agentgateway/reference/cel)
...
documentation](/workspaces/cortex/reference/agentgateway/reference/cel).
...
- Learn about [CEL expressions](/workspaces/cortex/reference/agentgateway/reference/cel) for advanced expression logic.
- Set up [authentication](/workspaces/cortex/reference/agentgateway/configuration/security/jwt-authn) to use JWT claims in transformations.
