...
Attaches to: [Listener](/workspaces/cortex/reference/agentgateway/configuration/security/docs/standalone/latest/configuration/listeners/ 'Listener')[Route](/workspaces/cortex/reference/agentgateway/configuration/security/docs/standalone/latest/configuration/routes/ 'Route')[Backend](/workspaces/cortex/reference/agentgateway/configuration/security/docs/standalone/latest/configuration/backends/ 'Backend')
:::note[Note]
