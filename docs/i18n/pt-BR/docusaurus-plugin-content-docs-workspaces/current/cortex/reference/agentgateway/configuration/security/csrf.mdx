...
```
    ...
    AGW->>AGW: CSRF validation:<br/>Origin (malicioussite.com)<br/>vs Destination (api.%PROJECT_DOMAIN%)
    ...
    User->>AGW: POST /api/action<br/>Origin: allowThisOne.%PROJECT_DOMAIN%<br/>Cookie: session=abc123
...
- Examples: `"https://www.%PROJECT_DOMAIN%"`, `"http://localhost:3000"`
