...
description: 'Apply Azure AI Content Safety to detect harmful content and jailbreak attempts in LLM requests and'
sidebar_position: 2
---
...
[azure-content-safety-config.yaml](/workspaces/cortex/reference/agentgateway/./llm/prompt-guards/https:/agentgateway.dev/examples/llm-prompt-guard/azure-content-safety-config.yaml)
