...
1. In the Auth0 Dashboard, go to **Applications > APIs** and click **Create API**. Enter a name such as
   ...
   such as `https://api.%PROJECT_DOMAIN%`. The identifier becomes the `aud` claim of the tokens that Auth0
   issues.
...
5. Save the values that the rest of this guide uses.
   ...
   export AUTH0_AUDIENCE='https://api.%PROJECT_DOMAIN%'
...
3. Confirm that agentgateway appends your audience to Auth0’s authorization endpoint.
   ...
   ```
   ...
   "authorization_endpoint": "https://your-tenant.us.auth0.com/authorize?audience=https://api.%PROJECT_DOMAIN%",
