...
description: 'Explore the CEL expression context interactively, including all available variables and their nested'
sidebar_position: 2
---
...
The complete URI of the request. For example, `http://%PROJECT_DOMAIN%/path`.
...
The hostname of the request. For example, `%PROJECT_DOMAIN%`.
