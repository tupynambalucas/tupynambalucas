...
- **Armazenamento de Objetos:** Ativos binários são persistidos em buckets compatíveis com S3 do Cloudflare R2, garantindo um footprint mínimo no Git. Consulte as especificações de [Armazenamento Cloudflare R2](/docs/workspaces/studio/reference/spec/cloudflare-storage).
