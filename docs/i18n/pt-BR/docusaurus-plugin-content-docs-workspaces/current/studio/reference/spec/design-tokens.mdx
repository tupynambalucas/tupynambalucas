...
Este documento serve como a única fonte de verdade para as constantes técnicas de design, paletas de cores, regras de tipografia e integrações de folhas de estilo do projeto `%PROJECT_DOMAIN%`.
