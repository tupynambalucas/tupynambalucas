...
|                      | [Tutorials](/docs/reference/diataxis/tutorials#tutorials) | [How-to guides](/docs/reference/diataxis/how-to-guides#how-to) | [Reference](/docs/reference/diataxis/reference-docs#reference) | [Explanation](/docs/reference/diataxis/explanation-docs#explanation) |
| -------------------- | --------------------------------------------------------- | -------------------------------------------------------------- | -------------------------------------------------------------- | -------------------------------------------------------------------- |
