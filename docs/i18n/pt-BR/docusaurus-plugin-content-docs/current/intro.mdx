...
3. **Iniciar Infraestrutura Local & Aplicações:**
   ...
   Consulte [.github/README.md](https://github.com/tupynambalucas/tupynambalucas/blob/develop/.github/README.md) ou a [Referência de Comandos](./reference/commands.mdx) para obter detalhes sobre a execução do `pnpm hub:dev`.
