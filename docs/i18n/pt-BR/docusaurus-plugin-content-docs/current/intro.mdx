  ...
  items={[
    {
      ...
      label: 'Start Here',
      description: 'The best way to get started with Diátaxis is by applying it.',
    },
    {
      type: 'link',
      href: '/docs/guides/diataxis/applying-diataxis',
      label: 'Applying Diátaxis',
      description: 'Make immediate, concrete sense of the approach.',
    },
    {
      type: 'link',
      href: '/docs/explanation/diataxis/theory',
      label: 'Understanding Diátaxis',
      description: 'Explore the theory and principles more deeply.',
    },
  ]}
/>
