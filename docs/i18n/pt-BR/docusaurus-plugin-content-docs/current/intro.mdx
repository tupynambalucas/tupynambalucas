...
3. **Iniciar Infraestrutura Local & Aplicações:**
   ...
   Consulte [MONOREPO.readme.md](https://github.com/tupynambalucas/tupynambalucas/blob/develop/MONOREPO.readme.md) ou a [Referência de Comandos](./reference/commands.mdx) para obter detalhes.
