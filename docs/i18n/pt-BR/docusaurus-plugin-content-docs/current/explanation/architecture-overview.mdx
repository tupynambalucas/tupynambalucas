...
<DocCardList
  items={[
    {
      type: 'link',
      href: '/docs/workspaces/infrastructure/intro',
    ...
    {
      type: 'link',
      href: '/docs/workspaces/infrastructure/guides/local-development',
...
O %PROJECT_DOMAIN% segue uma estratégia de segurança em múltiplas camadas. Para detalhes detalhados de implementação, consulte o documento de **[Arquitetura de Segurança](/docs/handbook/reference/security)**.
