  ...
  items={[
    {
      ...
      description:
        'Para manter a infraestrutura do %PROJECT_DOMAIN%, ferramentas de DevOps e ambientes de execução em segundo plano robustos, fáceis de manter e altamente modulares, este documento unifica nossos padrões de infraestrutura auto-hospedada, convenções de diretório e topologias Docker multisserviço.',
    },
    {
      type: 'link',
      ...
      label: 'Implantação',
      description:
        'Para garantir alta disponibilidade, segurança e ambientes reproduzíveis, o %PROJECT_DOMAIN% utiliza um modelo de implantação moderno e auto-hospedado projetado para máquinas virtuais Hetzner Cloud. Este guia descreve nossa estratégia de implantação, sincronização de ambiente e procedimentos operacionais.',
    },
  ]}
/>
...
O %PROJECT_DOMAIN% segue uma estratégia de segurança em múltiplas camadas. Para detalhes detalhados de implementação, consulte o documento de **[Arquitetura de Segurança](../reference/security.mdx)**.
