...
- **Object Storage:** Binary assets are persisted in S3-compatible Cloudflare R2 buckets, ensuring a minimal Git footprint. Refer to the [Cloudflare R2 Storage](/docs/workspaces/studio/reference/spec/cloudflare-storage) specs.
