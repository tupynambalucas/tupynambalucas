...
The Hub workspace contains all applications and packages related to the personal developer website. It is the primary storefront for %PROJECT_DOMAIN%, providing a professional portfolio, blog engine, technical skills inventory, and contact form handling systems.
...
- **Design Parity**: Inherits theme variables, colors, and layout constants directly from the `@repo/studio/assets` package.
