...
Attaches to: [Backend](https://agentgateway.dev/docs/standalone/latest/configuration/backends/ 'Backend')(AI Backends only)
...
consumption](https://agentgateway.dev/docs/standalone/latest).
