...
In additional to simple request-based rate limits, agentgateway can limit requests based on _tokens_ for [LLM consumption](/workspaces/cortex/reference/agentgateway/llm).
