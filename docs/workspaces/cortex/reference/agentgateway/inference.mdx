...
description: >-
  Configure Kubernetes Gateway API or standalone inference routing for AI
  workloads.
sidebar_position: 2
...
[Set up Kubernetes inference routing](/workspaces/cortex/reference/agentgateway/docs/kubernetes/latest/inference/)
...
[config.yaml](/workspaces/cortex/reference/agentgateway/./https:/agentgateway.dev/examples/llm-standalone-epp/config.yaml)
