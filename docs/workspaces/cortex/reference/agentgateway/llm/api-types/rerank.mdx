...
title: Rerank
description: >-
  Send rerank requests through agentgateway using the Cohere-compatible Rerank
  API.
sidebar_position: 2
...
provider](/workspaces/cortex/reference/agentgateway/llm/providers/cohere) guide.
