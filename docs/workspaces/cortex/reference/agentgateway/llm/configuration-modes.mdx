...
description: >-
  Use traditional HTTP routing configuration for advanced use cases like
...
For more MCP listener context, see [MCP overview](https://agentgateway.dev/docs/standalone/latest).
