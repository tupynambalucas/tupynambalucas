...
[Regex filtersUse custom regex patterns and built-in PII detectors to filter LLM requests and responses.](https://agentgateway.dev/docs/standalone/latest) [OpenAI moderationUse the OpenAI Moderation API to detect harmful content across categories including hate, harassment, and violence.](https://agentgateway.dev/docs/standalone/latest) [AWS Bedrock GuardrailsApply AWS Bedrock Guardrails to filter LLM requests and responses for policy-violating content.](https://agentgateway.dev/docs/standalone/latest) [Google Model ArmorApply Google Cloud Model Armor templates to sanitize LLM requests and responses.](https://agentgateway.dev/docs/standalone/latest) [Custom webhooksIntegrate your own content safety logic by forwarding requests and responses to a custom webhook.](/workspaces/cortex/reference/agentgateway/llm/prompt-guards/webhooks) [Multi-layered guardrailsRun prompt guards in sequence, creating defense-in-depth protection.](https://agentgateway.dev/docs/standalone/latest)
