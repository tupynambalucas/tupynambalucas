...
- [CEL expression reference](https://agentgateway.dev/docs/standalone/latest)
...
- Learn about [CEL expressions](https://agentgateway.dev/docs/standalone/latest) for advanced expression logic.
