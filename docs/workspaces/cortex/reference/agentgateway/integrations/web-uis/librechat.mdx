...
title: LibreChat
description: >-
  Front LibreChat with agentgateway to centralize LLM credentials, audit, and
  rate limits.
sidebar_position: 2
...
:::note[Note]
If LibreChat runs in Docker and agentgateway runs on your host machine, replace localhost with host.docker.internal : baseURL : "http://host.docker.internal:3000/v1"
:::
