...
title: Open WebUI
description: >-
  Front Open WebUI with agentgateway to centralize auth, audit, and rate limits
  for LLM traffic.
sidebar_position: 2
...
1. [Install the agentgateway binary](/workspaces/cortex/reference/agentgateway/deployment/binary) or have a container image available.
...
For other providers, see the [LLM providers guide](/workspaces/cortex/reference/agentgateway/llm/providers).
