...
|                      | [Tutorials](/workspaces/docs/reference/diataxis/tutorials) | [How-to guides](/workspaces/docs/reference/diataxis/how-to-guides) | [Reference](/workspaces/docs/reference/diataxis/reference-docs) | [Explanation](/workspaces/docs/reference/diataxis/explanation-docs) |
| -------------------- | ---------------------------------------------------------- | ------------------------------------------------------------------ | --------------------------------------------------------------- | ------------------------------------------------------------------- |
