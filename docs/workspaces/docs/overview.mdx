---
title: Docs Workspace (%PROJECT_DOMAIN% Docs)
...
The Docs workspace manages the official documentation hub for the %PROJECT_DOMAIN% project, known as **%PROJECT_DOMAIN% Docs**. Built on Docusaurus, it serves as the central developer portal, housing architectural guidelines, style guides, product planning documents, and automated project changelogs and roadmaps.
...
%PROJECT_DOMAIN% Docs is configured with a multi-instance documentation setup using Docusaurus plugins to segment the different areas of the developer portal with independent left sidebars:
...
%PROJECT_DOMAIN% Docs fully supports English (`en`) and Portuguese (`pt-BR`) locales. Localized files mirror the structure of English documents:
