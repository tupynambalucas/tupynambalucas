...
- [Tutorials](/workspaces/docs/reference/diataxis/tutorials) \- learning-oriented experiences

- [How-to guides](/workspaces/docs/reference/diataxis/how-to-guides) \- goal-oriented directions

- [Reference](/workspaces/docs/reference/diataxis/reference-docs) \- information-oriented technical description

- [Explanation](/workspaces/docs/reference/diataxis/explanation-docs) \- understanding-oriented discussion
...
- [The compass](/workspaces/docs/reference/diataxis/compass) \- a simple tool for direction-finding

- [Workflow](/workspaces/docs/guides/diataxis/workflow) in Diátaxis
