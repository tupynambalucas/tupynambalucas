...
title: Diátaxis in complex hierarchies
sidebar_position: 6
---
...
have an inherent mechanical order - numerical, or alphabetical. _Seven items_
_seems to be a comfortable general limit._ If you find that you’re looking at
...
introduce them. _Remember that you are always authoring for a human user, not_
_fulfilling the demands of a scheme._
...
different - what they need is documentation not for _product_,
but
...
This will _tend_ towards a clear, explicit, structural division into the four
...
What we must document is the product _as it is for the user_, the product as
...
contributors, how do _they_ see the product? Should we assume that a
...
began with](/workspaces/docs/explanation/diataxis/complex-hierarchies#structure-of-documentation-content), that’s not a problem - as long as there _is_
