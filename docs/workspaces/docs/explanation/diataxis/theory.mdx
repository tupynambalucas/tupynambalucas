...
- [Foundations](/workspaces/docs/explanation/diataxis/foundations) \- _why_ Diátaxis works

- [The map](/workspaces/docs/reference/diataxis/map) \- documentation in two dimensions

- [Towards a theory of quality in documentation](/workspaces/docs/explanation/diataxis/quality)

Common problems explored:

- [The difference between a tutorial and how-to guide](/workspaces/docs/explanation/diataxis/tutorials-vs-how-to)

- [The difference between reference and explanation](/workspaces/docs/explanation/diataxis/reference-vs-explanation)

- [Diátaxis in complex hierarchies](/workspaces/docs/explanation/diataxis/complex-hierarchies)
